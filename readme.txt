                               CSCI  Project 2
                              Network (The Game)
                       Due 11:55pm Friday, November 5, 2010
...
==================
Design the classes, modules, and interfaces (see "Teamwork").      Oct 11
Have working code for the easier modules.                          Oct 18
Have working code for identifying a network; progress on search.   Oct 25
Project mostly complete                                            Nov  1
...
against each other.  Participation in the tournament is optional.  The top
finishers in the tournament will get extra credit points which will improve
their grade if they are not at an "A" overall.

You will submit your contestant several weeks after the
...
refereeing software) on the time to perform one chooseMove().  Use
System.currentTimeMillis() to get the current time in milliseconds, and 
make sure you stop searching before 5000 ticks.

This is a difficult project.  Do not wait to start working on it.  If you don't
have the code that identifies legal moves implemented by Oct 18th, you
...
Teamwork (10% of project grade) (show to your TA in Lab 7, Oct 12)
========
...
(Oct 12).  Your Lab 7 score depends on having a finished draft of your
